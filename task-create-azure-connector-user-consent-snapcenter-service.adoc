...
默认情况下，您可以从 Azure Marketplace 在 Azure 中创建 Connector 。执行步骤至时 https://docs.netapp.com/us-en/cloud-manager-connector/task-launching-azure-mktp.html["从 Azure Marketplace 创建连接器"^]，您应记住以下几点：
...
如果在 Azure Active Directory 中启用了用户同意， https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-azure.html["从 Cloud Manager 创建 Connector"^]。
...
. https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-azure.html["从 Cloud Manager 创建 Connector"^]。
